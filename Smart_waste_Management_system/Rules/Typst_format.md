# Typst Document Format Rules — Smart Waste Management System Submissions & Blackbook
...
#if not is-assembly [
  #align(center)[
    #text(size: 16pt, weight: "bold")[Smart Waste Management System]
    #v(4pt)
...
```typst
#let declaration-page(student-name: "Aadish", project-title: "Smart Waste Management System") = [
  #set page(numbering: none)
  #align(center)[
...
#v(1cm)
Smart Waste Management System is a community-powered WhatsApp misinformation fact-checker...
#pagebreak()
...
- **PDF Metadata:** Prepend `#set document(title: "Smart Waste Management System - <Section>", author: "Aadish")` to every `.typ` file.
