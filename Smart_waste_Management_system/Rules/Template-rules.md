...
> Location: [`/home/aadish/Documents/typst/Smart_waste_Management_system/Rules/Template-rules.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/Rules/Template-rules.md) & [`/home/aadish/Documents/typst/Smart_waste_Management_system/template/README.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/template/README.md)
...
AI agents operating in the `Smart Waste Management System` repository **MUST read and consult these templates** before generating dissertation chapters, requirements documents, or project submission files.

### 📌 Template Inventory & Reference Files

| Template File Path | Source Standard / Domain | Primary Use Case |
|---|---|---|
| [`template/srs_template-ieee.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/template/srs_template-ieee.md) | IEEE Std 830-1998 / ISO/IEC 29148 | Software Requirements Specifications (SRS), Functional & Non-Functional Requirements, System Features. |
| [`template/2020-Scrum-Guide-US.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/template/2020-Scrum-Guide-US.md) | Official Scrum Guide (2020) by Schwaber & Sutherland | Formal Scrum framework definitions, roles (Product Owner, Scrum Master, Developers), artifacts, and events. |
| [`template/SCRUM_Model.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/template/SCRUM_Model.md) | Agile Scrum Lifecycle & Ceremonies | Sprint planning, daily standups, sprint reviews, backlog refinement, and velocity metrics. |
| [`template/SDLC_Software_Process_Models.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/template/SDLC_Software_Process_Models.md) | Software Engineering Process Models | Comparative evaluation of Waterfall, Spiral, V-Model, Iterative, and Agile SDLC methodologies. |
| [`template/Extreme_Programming.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/template/Extreme_Programming.md) | Extreme Programming (XP) | Technical engineering practices: Pair Programming, Test-Driven Development (TDD), Refactoring, Continuous Integration. |
| [`template/Kanban.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/template/Kanban.md) | Kanban Flow & Lean Development | Work-In-Progress (WIP) limits, visual workflow queues, cycle time optimization, and bottleneck management. |
| [`template/FDD.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/template/FDD.md) | Feature-Driven Development (FDD) | Feature list decomposition, domain object modeling, milestone tracking, and chief programmer strategy. |
...
1. **Scenario 1: Creating any SRS or Functional Requirements Submission**
   ...
   - *Action:* Open and read [`template/srs_template-ieee.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/template/srs_template-ieee.md).
...
2. **Scenario 2: Creating SDLC & Development Methodology Sections**
   ...
   - *Action:* Open and read [`template/SDLC_Software_Process_Models.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/template/SDLC_Software_Process_Models.md).
   - *Requirement:* Compare traditional vs modern models, justifying why Smart Waste Management System uses Agile/Scrum.
...
3. **Scenario 3: Creating Scrum Sprint & Ceremony Documentation**
   ...
   - *Action:* Open and read [`template/2020-Scrum-Guide-US.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/template/2020-Scrum-Guide-US.md) and [`template/SCRUM_Model.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/template/SCRUM_Model.md).
...
Step 3: Read Core Project Documentation (CODE_PATHS_AND_NOTES.md & codebase)
  ↓
Step 4: Map Smart Waste Management System Architecture onto Template Structure
  ↓
...
2. **Step 2 — Read Smart Waste Management System Architecture**: Inspect [`Rules/CODE_PATHS_AND_NOTES.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/Rules/CODE_PATHS_AND_NOTES.md) and `src/lib/types.ts` to get Smart Waste Management System's actual 7 system modules, Firebase backend architecture, Jaccard similarity math, and `html2canvas` card generator specs.
3. **Step 3 — Fuse Template Structure with Smart Waste Management System Specifics**: Replace generic placeholders (`<Project>`, `<author>`, `<Feature 1>`) with actual Smart Waste Management System facts:
...
4. **Step 4 — Format in Typst**: Follow formatting rules from [`Rules/Typst_format.md`](file:///home/aadish/Documents/typst/Smart_waste_Management_system/Rules/Typst_format.md):
