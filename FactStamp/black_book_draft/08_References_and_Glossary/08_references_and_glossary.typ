...
#styled-table(
  ...
  [Audit Log (`AdminAuditLog`)], [A Firestore-backed record of all admin actions. It logs the timestamp, admin identity, action, target type and ID, and details of every administrative change. Accessible through the Audit and Tools tab of the Admin Console.],
