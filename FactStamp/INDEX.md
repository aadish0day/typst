...
| **Admin Console (`/admin`) Reference** | [`Rules/Admin-rules.md`](file:///home/aadish/Documents/typst/FactStamp/Rules/Admin-rules.md) | Auth flow, 5-tab UI structure, data model, and backend service functions for the staff-only moderation console. |
| **8 Core System Modules → Source Files** | [`Rules/Module-rules.md`](file:///home/aadish/Documents/typst/FactStamp/Rules/Module-rules.md) | Maps Auth, Ingestion/OCR, Duplicate Detection, Verification Queue, Consensus Engine, Card Generator, Analytics, and Security modules to actual code paths. |
| **Master Required Diagrams Checklist** | [`Rules/Diagrams-Checklist.md`](file:///home/aadish/Documents/typst/FactStamp/Rules/Diagrams-Checklist.md) | All required diagrams mapped to syllabus section & tooling format. |
| **Dissertation Syllabus & Outline** | [`Rules/Project_syllabus.md`](file:///home/aadish/Documents/typst/FactStamp/Rules/Project_syllabus.md) | Official 7-chapter outline (Course `JUSIT-DSCPR503`) & mandatory front-matter requirements. |
| **IEEE 830 SRS Specification** | [`template/srs_template-ieee.md`](file:///home/aadish/Documents/typst/FactStamp/template/srs_template-ieee.md) | IEEE 830 standard template for functional/non-functional requirements, external interfaces, and system features. |
...
## Academic Dissertation Syllabus Structure (`Rules/Project_syllabus.md`)
